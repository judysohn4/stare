...
const Legal = () => {
    let [sites, setSites] = useState(["New York Times - subscription needed","CNN","LA Times - subscription needed","Politico","AP News"]);
    ...
    return (
        ...
        <div className = "flex flex-col h-screen bg-white justify-between">
            <div>
            <div className = "text-4xl text-black p-5">Legal Resources</div>
            <div className = "pl-5 text-xl">⇩Explore at Your Disposal⇩</div>
            <div className = "flex flex-col p-8 gap-3">
                <div className = "text-lg">~a collection of unknown to now known legal terms~</div>
                <div className="overflow-x-auto bg-">
                    <table className="table text-base">
                        ...
                        <tr>
                            <th>1</th>
                            <td><b>Stare Decisis</b></td>
                            <td>the legal principle of determining points in litigation according to precedent</td>
                        </tr>
                        {/* row 2 */}
                        <tr>
                            <th>2</th>
                            <td><b>Held</b></td>
                            <td>decided or ruled binding; can only be set aside by appealing the judgement before a higher forum</td>
                        </tr>
                        {/* row 3 */}
                        <tr>
                            <th>3</th>
                            <td><b>Circuit</b></td>
                            <td>94 federal judicial districts are organized into 12 regional circuits, each of which has a court of appeals Each of the thirteen federal circuit courts is assigned one Supreme Court Justice, who considers certain appeals (e.g., emergency requests and other matters) from his or her assigned circuit while other aspects of the case are still pending</td> 
                        </tr>
                        
                        <tr>
                            <th>4</th>
                            <td><b>but-for causation</b></td>
                            <td>an action is a cause of an injury if, but for the action, the injury wouldn't have occurred Ex. Driver of “Car A” runs a red light and hits “Car B,” which had a green light, causing injury to the driver of Car B</td>
                        </tr>

                        <tr>
                            <th>5</th>
                            <td><b>Textualism</b></td>
                            <td>a mode of legal interpretation that focuses on the plain meaning of the text of a legal document. Textualism usually emphasizes how the terms in the Constitution would be understood by people at the time they were ratified, as well as the context in which those terms appear</td>
                        </tr>
                    ...
                    <div className = "text-2xl">✧ Journalism Sites</div>
